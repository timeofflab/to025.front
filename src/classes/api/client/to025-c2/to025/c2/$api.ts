...
// prettier-ignore
import { Methods as Methods2 } from './presentation/project'
// prettier-ignore
import { Methods as Methods3 } from './presentation/project/_id@string'
// prettier-ignore
import { Methods as Methods4 } from './service/auth'
// prettier-ignore
import { Methods as Methods5 } from './service/auth/_token@string'
// prettier-ignore
import { Methods as Methods6 } from './service/hello'
        ...
        _token: (val2: string) => {
          ...
          return {
            ...
            put: (option?: { headers?: Methods5['put']['reqHeaders'], config?: T }) =>
              fetch<Methods5['put']['resBody'], BasicHeaders, Methods5['put']['status']>(prefix, prefix2, PUT, option).json(),
            /**
             * @returns A array of auth
             */
            $put: (option?: { headers?: Methods5['put']['reqHeaders'], config?: T }) =>
              fetch<Methods5['put']['resBody'], BasicHeaders, Methods5['put']['status']>(prefix, prefix2, PUT, option).json().then(r => r.body),
            $path: () => `${prefix}${prefix2}`
          }
        },
        /**
